...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let nib1 = UINib(nibName: "myTableViewCell", bundle: nil)
        self.tableView1.register(nib1, forCellReuseIdentifier: "myTableViewCell")
        let nib2 = UINib(nibName: "myTableViewCell", bundle: nil)
        self.tableView2.register(nib2, forCellReuseIdentifier: "myTableViewCell")
        let nib3 = UINib(nibName: "myTableViewCell", bundle: nil)
        self.tableView3.register(nib3, forCellReuseIdentifier: "myTableViewCell")
